...
public class LayoutRipple2 extends CustomView2 {
    ...
    OnLongClickListener onLongClickLisenter;
    ...
    public LayoutRipple2(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        if (rippleColor != -1) {
            ...
            // Color by hexadecimal
            int background = attrs.getAttributeIntValue(MATERIALDESIGNXML, "rippleColors", -1);
            if (background != -1)
                ...
                runnable = new Runnable() {
                    ...
                    public void run() {
                        if (onLongClickLisenter != null) {
                            isLongClick = true;
                            if (isLongClick) {
                                onLongClickLisenter.onLongClick(LayoutRipple2.this);
                            }
                        }
                    }
                };
