...
public class ButtonRectangle extends Button {
    ...
    public ButtonRectangle(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ButtonRectangle);
        int Color = ta.getColor(R.styleable.ButtonRectangle_br_textColor, getResources().getColor(R.color.thumbColor));
