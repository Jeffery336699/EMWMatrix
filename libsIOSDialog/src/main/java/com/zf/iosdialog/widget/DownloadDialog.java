...
public class DownloadDialog {
	...
	private NumberProgressBar bar_number;
	...
	public DownloadDialog builder() {
		View view = LayoutInflater.from(context).inflate(
				R.layout.view_downloaddialog, null);
		...
		bar_number = (NumberProgressBar) view.findViewById(R.id.bar_number);
	...
	public DownloadDialog setPositiveButton(String text,
	...
	public DownloadDialog setNegativeButton(String text,
			final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
