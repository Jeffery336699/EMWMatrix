...
import cc.emw.mobile.record.cameralibrary2.lisenter.CaptureLisenter;
import cc.emw.mobile.record.cameralibrary2.lisenter.JCameraLisenter;
import cc.emw.mobile.record.cameralibrary2.lisenter.ReturnLisenter;
import cc.emw.mobile.record.cameralibrary2.lisenter.TypeLisenter;
import cc.emw.mobile.record.cameralibrary2.util.AudioUtil;
...
//        mTextureView.setSurfaceTextureListener(this);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            Toast.makeText(mContext, "启动相机失败！", Toast.LENGTH_SHORT).show();
    ...
    public void setTakePictureEnabled(boolean enabled) {
        mCaptureLayout.setTakePictureEnabled(enabled);
    }

    public void setRecordEnabled(boolean enabled) {
        mCaptureLayout.setRecordEnabled(enabled);
    }
}
