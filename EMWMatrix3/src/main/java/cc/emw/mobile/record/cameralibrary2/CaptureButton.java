...
public class CaptureButton extends View {
    ...
    private boolean isTakePictureEnabled = true; //#UPDATE 是否启用点击拍照
    private boolean isRecordEnabled = true; //#UPDATE 是否启用长按录制
    ...
    private void handlerUnpressByState() {
        ...
        switch (state) {
            case STATE_PRESS_CLICK:
                if (isTakePictureEnabled && captureLisenter != null) {
