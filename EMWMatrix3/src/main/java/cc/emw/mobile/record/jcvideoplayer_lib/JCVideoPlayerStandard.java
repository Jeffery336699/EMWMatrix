...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.thumb) {
            Log.e("JCVideoPlayerStandard","-------onClick thumb-------");
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Log.e("JCVideoPlayerStandard","-------showWifiDialog-------");
                startVideo();
    ...
    public void startVideo() {
        Log.e("JCVideoPlayerStandard","JCVideoPlayerStandard----startVideo()");
        prepareMediaPlayer();
        onEvent(JCUserActionStandard.ON_CLICK_START_THUMB);
        if (url.startsWith("http")) {  //#UPDATE
            downLoadVideo(getContext());
        }
    }
    ...
    public void changeUiToCompleteShow() {
        switch (currentScreen) {
            ...
            case SCREEN_LAYOUT_LIST:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.VISIBLE, View.INVISIBLE, View.INVISIBLE); //#UPDATE
                updateStartImage();
                break;
            case SCREEN_WINDOW_FULLSCREEN:
                setAllControlsVisible(View.VISIBLE, View.VISIBLE, View.VISIBLE,
    ...
    public void setAllControlsVisible(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        if (thumbImg == View.INVISIBLE) { //#UPDATE 延迟，避免播放时黑一下
