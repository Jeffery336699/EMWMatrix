package cc.emw.mobile.record.cameralibrary;
...
import cc.emw.mobile.record.cameralibrary.lisenter.CaptureLisenter;
import cc.emw.mobile.record.cameralibrary.util.CheckPermission;

import static cc.emw.mobile.record.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static cc.emw.mobile.record.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static cc.emw.mobile.record.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
