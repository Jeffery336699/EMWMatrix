 ...
 * @author yuanhang.liu
 * @package cc.emw.mobile.chat
 * @data on 2018/8/15  15:39
 * @describe TODO
 */
@ContentView(R.layout.activity_mystar_msg)
public class MyStarMsgActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        importantMsgAdapter.setListener(new GetMessageListener() {
            @Override
    ...
    private void getImportanceMessages2Group() {
        API.Message.GetGroupMessagesByState(PrefsUtil.readUserInfo().ID, groupId + "", 1, 200, 2, new RequestCallback<ImprotanceMessage>(ImprotanceMessage.class) {
            @Override
            ...
            public void onError(Throwable throwable, boolean b) {
                ToastUtil.showToast(MyStarMsgActivity.this, "获取信息失败！");
            }
        });
    }

    private void getImportanceMessage2User() {
        API.Message.GetChatMyStarMessages(senderId, 1, 200, new RequestCallback<ImprotanceMessage>(ImprotanceMessage.class) {
            @Override
            public void onError(Throwable throwable, boolean b) {
                ToastUtil.showToast(MyStarMsgActivity.this, "获取信息失败！");
            }
    ...
    private void updateImportanceMessage(String msgId, final int state) {
        API.Message.UpdateOptionsByID(msgId, state, new RequestCallback<String>(String.class) {
            ...
            public void onError(Throwable throwable, boolean b) {
                ...
                ToastUtil.showToast(MyStarMsgActivity.this, "删除失败！");
            }
            ...
            public void onSuccess(String result) {
                ...
                mBottomDelTv.setTextColor(Color.parseColor("#C0C0C0"));
                ToastUtil.showToast(MyStarMsgActivity.this, "删除成功！");
            }
        });
    }
    ...
    public interface GetMessageListener {
        ...
        void GetMessageIndex(final ImprotanceMessage message);
    }
}
