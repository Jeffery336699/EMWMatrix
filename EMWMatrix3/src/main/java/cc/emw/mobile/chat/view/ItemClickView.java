...
/**
 * Created by xiang.peng on 2016/7/19.
 */
...
public class ItemClickView extends LinearLayout {
    ...
    public ItemClickView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_rippleColors,
                mRippleColor);
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(ItemClickView.this, 1);
                    mIsAnimating = false;
                }
