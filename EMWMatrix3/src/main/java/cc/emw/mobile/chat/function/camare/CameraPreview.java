package cc.emw.mobile.chat.function.camare;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, AutoFocusCallback {
	...
	public void updateCameraParameters() {
		if (camera != null) {
			...
			Camera.Parameters parameters = setParameters(p);
			try {
	...
	public Camera.Parameters setParameters(Camera.Parameters parameters) {
