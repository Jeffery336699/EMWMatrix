...
public class ChatButtonRoundnessMenuLayout2 extends ViewGroup {
    /**
     * MenuItem的点击事件接口
     */
    ...
    public ChatButtonRoundnessMenuLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        setMenuItemIconsAndTexts(new String[]{"拍照","我的照片","视频","我的视频"}
                , new String[]{"Photo Graph","My Photo","Video","My Video"});
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        Log.d("sunny----->","1111111111111111111111onLayout=");
