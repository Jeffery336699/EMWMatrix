...
import cc.emw.mobile.chat.map.adapter.SearchAdapter;
import cc.emw.mobile.chat.map.bean.SearchAddressInfo;
import cc.emw.mobile.map.ToastUtil;


public class SearchAddressActivity extends BaseActivity implements View.OnClickListener, PoiSearch.OnPoiSearchListener, AdapterView.OnItemClickListener {
    ...
    private void iniView() {
        ...
        mRootLayout = (RelativeLayout) findViewById(R.id.activity_search_address);
    ...
    public void onClick(View v) {
        if (v == search) {
            dealSearch();
        } else if (v.getId() == R.id.activity_search_address) {
            finish();
        }
    }
