package cc.emw.mobile.chat.function.cropper;
...
import cc.emw.mobile.chat.function.CropperImage;
import cc.emw.mobile.chat.function.cropper.cropwindow.CropOverlayView;
import cc.emw.mobile.chat.function.cropper.cropwindow.edge.Edge;
import cc.emw.mobile.chat.function.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.camare_crop_image_view, this, true);
