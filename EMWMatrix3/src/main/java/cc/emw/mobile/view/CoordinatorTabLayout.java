...
/**
 * Created by tao.zhou on 2017/7/8.
 */
...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    private void initView(Context context) {
        ...
        mHeadLayout = (LinearLayout) findViewById(R.id.ll_my_head);
    }
    ...
    private void setupTabLayout() {
        mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                mHeadLayout.startAnimation(AnimationUtils.loadAnimation(mContext, R.anim.anim_dismiss));
...
//                }
                mHeadLayout.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.anim_show));
            }
