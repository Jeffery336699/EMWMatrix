 ...
 */
public class MyTwoDirectScrollView extends FrameLayout {
    ...
    public MyTwoDirectScrollView(Context context) {
        super(context);
        init(context);
    }

    public MyTwoDirectScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyTwoDirectScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
