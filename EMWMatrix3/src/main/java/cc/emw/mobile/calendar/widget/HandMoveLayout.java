package cc.emw.mobile.calendar.widget;
...
import cc.emw.mobile.calendar.adapter.CalendarBaseAdpter;
import cc.emw.mobile.calendar.utils.MomentsUtils;
...
public class HandMoveLayout extends LinearLayout {
    ...
    private void init() {
        if (mHeader == null && mContent == null) {
            ...
            int contentId = getResources().getIdentifier("hand_move", "id", getContext().getPackageName());
...
//                mHeader = (LinearLayout) findViewById(headerId);
                ...
                weekViewpager.setVisibility(GONE);//初始化隐藏,这是最佳时机
//                无事件的布局
...
//                    headerOriginalHeight = mHeader.getMeasuredHeight();
                    headerOriginalHeight = MomentsUtils.dip2px(getContext(), 245);//此处由于娶不到高度，所以写死
...
//                    mHeader.setLayoutParams(params);
                    ...
                    params2.setMargins(0, -MomentsUtils.dip2px(getContext(), 205), 0, 0);//月视图-周视图的高度
...
//                    }
        ...
        intentBroadCast.setAction("cc.emw.mobile.show_top_and_bottom");
...
//                    }
        ...
        Intent intentBroadCast = new Intent();
        intentBroadCast.setAction("cc.emw.mobile.hide_top_and_bottom");
        getContext().sendBroadcast(intentBroadCast);
    }
