package cc.emw.mobile.task.base;
...
public abstract class BaseHolder<T> {
     ...
     * @param data
     */
    public void setDataAndRefreshHolderView(int postion,T data) {
        mData=data;
        refreshHolderView(postion,data);
    }
    /**
     * @des  进行数据和视图的绑定操作
     * @cal  集成BaseHolder必写方法    重载不同情况下实现
     */
    public abstract void refreshHolderView(int postion,T data);
