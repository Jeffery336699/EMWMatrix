...
public final class NotificationUtil {
	...
	public static void notificationForDLAPK(Context context, String url,
											String path) {
		notificationForDLAPK(context, url, path, "", 0);
	}

	public static void notificationForDLAPK(Context context, String url,
			String path, int fid, boolean isShow) {
		notificationForDLAPK(context, url, path, "", fid, isShow);
	}

	public static void notificationForDLAPK(Context context, String url,
											String path, String name) {
		notificationForDLAPK(context, url, path, name, 0);
	}

	public static void notificationForDLAPK(Context context, String url,
			String path, String name, int fid) {
		notificationForDLAPK(context, url, path, name, fid, true);
	}

	public static void notificationForDLAPK(Context context, String url,
											String path, String name, int fid, boolean isShow) {
