package cc.emw.mobile.me.tablayout;
...
import cc.emw.mobile.me.tablayout.utils.FragmentChangeManager;
import cc.emw.mobile.me.tablayout.utils.UnreadMsgUtils;
import cc.emw.mobile.me.tablayout.widget.MsgView;
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView tab_subtitle = (TextView) tabView.findViewById(R.id.tv_tab_subtitle);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            float textWidth1 = mTextPaint.measureText(tv_tab_title.getText().toString());
            float textWidth2 = mTextPaint.measureText(tv_tab_subtitle.getText().toString());
            float textWidth = textWidth1 > textWidth2 ? textWidth1 : textWidth2;
