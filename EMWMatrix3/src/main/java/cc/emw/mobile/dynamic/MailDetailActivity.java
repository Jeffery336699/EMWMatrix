 ...
 */
@ContentView(R.layout.activity_mail_detail)
public class MailDetailActivity extends BaseActivity {
    ...
    private TextView mCallUserTv; //收件人文本
    ...
    private TextView mCallUserNum; //收件人数量
    @ViewInject(R.id.tv_phone_answeruser)
    private TextView mAnswerUserTv; //抄送人文本
    ...
    private void initView() {
        ...
        if (userSchedule != null) {
            ...
            showCallUser(userSchedule.Receiver);
            showAnswerUser(TaskUtils.getUsers(userSchedule.CopySender));
...
//            mMainUserTv.setVisibility(View.VISIBLE);
    ...
    private void showAnswerUser(List<ApiEntity.UserInfo> moreUsers) {
