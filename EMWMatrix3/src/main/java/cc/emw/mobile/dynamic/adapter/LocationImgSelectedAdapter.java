...
public class LocationImgSelectedAdapter extends RecyclerView.Adapter<LocationImgSelectedAdapter.ViewHolder> {
    ...
    public LocationImgSelectedAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_item_dynamic_select_img, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.mIcTvDel.setTag(uri);
        holder.mIcTvDel.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mImg = (ImageView) itemView.findViewById(R.id.iv_dynamic_img_select_item);
            mIcTvDel = (IconTextView) itemView.findViewById(R.id.itv_select_img_del);
        }

        ImageView mImg;
        IconTextView mIcTvDel;
    }

    public interface OnRvItemClickListener {
        void onRItemClickListener(String position);
    }
}
