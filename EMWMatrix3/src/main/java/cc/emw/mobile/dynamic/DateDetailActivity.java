...
public class DateDetailActivity extends BaseActivity {
    ...
    private TextView mPlaceEt; //约会地点
    ...
    private void initView() {
        ...
        if (userSchedule != null) {
            ...
            mPlaceEt.setText(userSchedule.Place);
            ...
            if (!TextUtils.isEmpty(userSchedule.MustActor)) {
                showCallUser(TaskUtils.getUsers(userSchedule.MustActor));
            }
