 ...
 */
@ContentView(R.layout.activity_phone_detail)
public class PhoneDetailActivity extends BaseActivity {
    ...
    private TextView mTelNumEt; //电话号码
    ...
    private void initView() {
        ...
        if (userSchedule != null) {
            ...
            showCallUser(userSchedule.Launcher);
            showAnswerUser(userSchedule.Receiver);
            mTelNumEt.setText(userSchedule.Phone);
            mRadioGroup.check(userSchedule.PhoneType == 0? R.id.rb_plan_day : R.id.rb_plan_week);
