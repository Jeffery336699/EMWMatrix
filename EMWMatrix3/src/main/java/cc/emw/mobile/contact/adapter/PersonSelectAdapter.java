...
public class PersonSelectAdapter extends BaseAdapter implements SectionIndexer {
	...
	public PersonSelectAdapter(Context context, EditTag editTag) {
		this.mContext = context;
		this.mEditTag = editTag;
...
//				.showImageOnFail(R.drawable.cm_img_head) // 设置图片加载或解码过程中发生错误显示的图片
	...
	public View getView(final int position, View contentView, ViewGroup arg2) {
		...
		vh.okItv.setVisibility(mEditTag.hasTag(user) ? View.VISIBLE : View.GONE);
