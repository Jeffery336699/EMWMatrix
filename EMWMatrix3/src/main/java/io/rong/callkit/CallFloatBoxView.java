...
public class CallFloatBoxView {
    ...
    public static void showFloatBox(Context context, Bundle bundle, int time) {
        ...
        TextView timeTv = (TextView) mView.findViewById(R.id.rc_time);
        FrameLayout previewLayout = (FrameLayout) mView.findViewById(R.id.rc_voip_float_preview);
        ...
        if (mediaType.equals(RongCallCommon.CallMediaType.AUDIO)) {
            ...
            if (action != null && !action.equals(RongVoIPIntent.RONG_INTENT_ACTION_VOIP_MULTIVIDEO)) {
                mediaIconV.setVisibility(View.GONE);
...
//                    localVideo = profile.getVideoView();
                    ...
                    previewLayout.addView(remoteVideo);
                }
            }
        }
