...
public class CircleProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = a.getDimensionPixelOffset(
                R.styleable.CircleProgressBar_progress_textsize, (int) (DEFAULT_TEXT_SIZE * density));
        mTextColor = a.getColor(
                R.styleable.CircleProgressBar_progress_textcolor, Color.BLACK);
        ...
        int textVisible = a.getInt(R.styleable.CircleProgressBar_progress_textvisibility, 1);
        if (textVisible != 1) {
            mIfDrawText = true;
        }
