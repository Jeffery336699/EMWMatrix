...
/**
 * Created by ${zrjt} on 2016/11/21.
 */
public class MyTwoDirectScrollViews extends FrameLayout {
    ...
    public MyTwoDirectScrollViews(Context context) {
        super(context);
        init(context);
    }

    public MyTwoDirectScrollViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyTwoDirectScrollViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setScrollView2(View view2){
        mView2 = view2;
    }
