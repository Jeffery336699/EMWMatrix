...
public class SlideBottomPanel extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < mChildCount; i++) {
            ...
            if (childView.getTag() == null || Integer.valueOf(String.valueOf(childView.getTag())) != TAG_BACKGROUND) {
...
//                }
            } else if (Integer.valueOf(String.valueOf(childView.getTag())) == TAG_BACKGROUND){
