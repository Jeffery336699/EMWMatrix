...
import cc.emw.mobile.task.adapter.WorkProjectMutiAdapter;
...
public class WorkProjectMutiActivity extends BaseActivity implements
		IWorkProjectView {
	...
	private WorkProjectMutiAdapter mAdapter;

	public static final String WORK_PROJECTS = "work_projects";
	private String mProjectIDs;
	public static final String WORK_PROJECT_IDS = "work_project_ids";

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		mProjectIDs = getIntent().getStringExtra(WORK_PROJECT_IDS);
		initView();
	}

	private void initView() {
		mAdapter = new WorkProjectMutiAdapter(this, mProjectIDs);
	...
	private void onHeaderClick(View v) {
		...
		case R.id.cm_header_tv_right:
			ArrayList<UserProject> userProjectList = mAdapter
					.getUserProjectList();
			setResult(Activity.RESULT_OK,
					getIntent().putExtra(WORK_PROJECTS, userProjectList));
			onBackPressed();
			break;
