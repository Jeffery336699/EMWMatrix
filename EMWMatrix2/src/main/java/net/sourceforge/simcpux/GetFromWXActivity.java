	...
	private void initView() {
		...
		findViewById(R.id.get_text).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				MMAlert.showAlert(GetFromWXActivity.this, "share text", editor, getString(R.string.app_shares), getString(R.string.app_cancel), new DialogInterface.OnClickListener() {
