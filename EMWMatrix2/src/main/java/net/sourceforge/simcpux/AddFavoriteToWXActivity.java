	...
	private void initView() {
		...
		findViewById(R.id.send_text).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				MMAlert.showAlert(AddFavoriteToWXActivity.this, "send text", editor, getString(R.string.app_shares), getString(R.string.app_cancel), new DialogInterface.OnClickListener() {
