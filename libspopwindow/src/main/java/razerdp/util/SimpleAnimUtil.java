...
public class SimpleAnimUtil {
    ...
    public static AnimatorSet getDefaultSlideFromBottomAnimationSet(View mAnimaView) {
        ...
        if (mAnimaView != null) {
            set.playTogether(
                    ObjectAnimator.ofFloat(mAnimaView, "translationY", 250, 0, 50, 0).setDuration(800),
                    ObjectAnimator.ofFloat(mAnimaView, "alpha", 0, 1).setDuration(250 * 3 / 2)
            );
        }
        return set;
    }

    public static AnimatorSet getDefaultSlideFromBottomPicAnimationSet(View mAnimaView) {
        AnimatorSet set = null;
        set = new AnimatorSet();
        if (mAnimaView != null) {
            set.playTogether(
                    ObjectAnimator.ofFloat(mAnimaView, "scaleY", 0, 1, 1).setDuration(400),
                    ObjectAnimator.ofFloat(mAnimaView, "alpha", 0, 1).setDuration(250 * 3 / 2)
            );
        }
        return set;
    ...
    public static AnimatorSet getDefaultSlideFromTopAnimationSet(View mAnimaView) {
        ...
        if (mAnimaView != null) {
            set.playTogether(
//                    ObjectAnimator.ofFloat(mAnimaView, "translationY", 0, 300).setDuration(400),
                    ObjectAnimator.ofFloat(mAnimaView, "scaleY", 1, 0, 0).setDuration(400),
                    ObjectAnimator.ofFloat(mAnimaView, "alpha", 1, 0).setDuration(250 * 3 / 2)
            );
        }
        return set;
    }
